...
from BasicWordbookModel import BasicWordbookModel
from BasicWordbookView import BasicWordbookView
...
class BasicWordbookController:
    ...
    def run_user_controller(self):
        from UserController import UserController
        user_controller = UserController(self.user_id)
        user_controller.run()
